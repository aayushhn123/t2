        ...
        <div class="metric-card">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 0.5rem;">
                <tr style="background: rgba(255, 255, 255, 0.1);">
                    ...
                    <tr>
                    <td style="padding: 0.5rem; border-bottom: 1px solid #ddd;">Overall Range</td>
                    <td style="padding: 0.5rem; border-bottom: 1px solid #ddd;">{st.session_state.non_elective_range}</td>
                </tr>
                <tr>
                    <td style="padding: 0.5rem; border-bottom: 1px solid #ddd;">Unique Exam Days</td>
                    <td style="padding: 0.5rem; border-bottom: 1px solid #ddd;">{st.session_state.unique_exam_days}</td>
                </tr>
                <tr>
                    <td style="padding: 0.5rem; border-bottom: 1px solid #ddd;">Elective Dates</td>
                    <td style="padding: 0.5rem; border-bottom: 1px solid #ddd;">{st.session_state.elective_dates_str}</td>
                </tr>
            </table>
        </div>
        """, unsafe_allow_html=True)
